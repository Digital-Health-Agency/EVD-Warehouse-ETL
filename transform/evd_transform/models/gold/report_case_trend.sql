    ...
    select
        *,
        ...
        round(
            ...
            1
        ) as moving_average_4_week_cases,
...
select
    ...
    moving_average_4_week_cases,
    previous_week_cases,

    total_cases
        - coalesce(previous_week_cases, 0)
        as weekly_case_change,
    ...
    round(
        ...
        / nullif(previous_week_cases, 0),
        1
    ) as weekly_case_change_percentage,
